...
export default function WhoWeAre({
  ...
  return (
    <motion.section
      ...
      className="w-full overflow-x-hidden bg-[#151515] px-4 py-[1.75rem] text-white min-[22.5rem]:py-[2rem] sm:px-[2rem] sm:py-[2.5rem] lg:px-[3rem] lg:py-[2.875rem] xl:py-[3.5rem] 2xl:py-[4rem]"
    >
      <div className="mx-auto grid w-full max-w-none items-stretch overflow-hidden bg-[#1b1b1b] sm:max-w-[64.25rem] lg:grid-cols-[minmax(0,1fr)_minmax(0,1.06fr)] xl:max-w-[80rem] 2xl:max-w-[90rem]">
        ...
        >
          ...
          >
            <Image
              src={images.meeting}
              alt={
                imageAlts?.meeting || "Team collaborating around a table"
              }
              fill
              priority
        ...
        <motion.div
          ...
          className="flex min-h-0 min-w-0 self-stretch flex-col justify-center px-[1.25rem] py-[1.75rem] min-[22.5rem]:px-[1.5rem] min-[22.5rem]:py-[2rem] sm:px-[2.5rem] sm:py-[2.5rem] lg:min-h-[26.125rem] lg:px-[2.625rem] lg:py-[2rem] xl:min-h-[31.25rem] xl:px-[3.25rem] 2xl:min-h-[35rem] 2xl:px-[4rem]"
        >
          <motion.h2
          ...
          {paragraphs.length > 0 && (
            <motion.div className="mt-[1.25rem] w-full max-w-none space-y-[1rem] break-words font-['DM_Sans'] text-[0.875rem] leading-[1.45] text-[#f0f0f0] [overflow-wrap:anywhere] sm:mt-[1.5rem] sm:max-w-[29.375rem] xl:max-w-[36rem] xl:text-[1.125rem] 2xl:max-w-[42rem]">
