...
export default function HeroSection({
  ...
  return (
    <section className="relative isolate min-h-[600px] overflow-hidden bg-neutral-900 text-white">
      ...
      <div className="mx-auto grid min-h-[600px] w-[calc(100%-40px)] max-w-[1560px] gap-10 sm:w-[calc(100%-64px)] lg:grid-cols-[minmax(0,1fr)_minmax(400px,500px)] 2xl:grid-cols-[960px_500px] 2xl:gap-[100px]">
        <div className="max-w-[785px] self-start pt-[170px] lg:pt-[199px]">
        ...
        <div className="self-start pt-[150px] lg:pt-[143px]">
          <DemoRequestForm />
        </div>
      </div>
    </section>
