...
export default function RevenuePanelSection({
  ...
  return (
    <section className="mx-auto w-[calc(100%-2rem)] max-w-[97.5rem] overflow-hidden bg-[#171717] text-white sm:w-[calc(100%-4rem)] lg:relative lg:h-[calc(41.25rem*var(--rp))] lg:[--rp:min(calc((100vw-4rem)/97.5rem),1)]">
      {/* laptop / desktop scaled layout */}
      <div className="relative hidden h-[41.25rem] w-[97.5rem] origin-top-left scale-[var(--rp)] lg:block">
      ...
      <div className="px-[1rem] py-[2rem] min-[23.4375rem]:px-[1.5rem] sm:px-[3rem] sm:py-[3rem] lg:hidden">
        <h2 className="text-[1.875rem] font-bold leading-[1.05] tracking-[-0.02em] min-[23.4375rem]:text-[2.125rem] sm:text-[2.75rem]">
          {heading}
        </h2>
        ...
        <div className="mt-[2.5rem] grid gap-[1.25rem]">
          {groups.map(([title, items]) => (
            <article
              key={title}
              className="border-[0.0625rem] border-neutral-700 bg-[#171717] p-[1rem] min-[23.4375rem]:p-[1.5rem]"
            >
        ...
        <div className="relative mt-[2.5rem] h-[13rem] w-full min-[23.4375rem]:h-[18rem]">
          <Image
            src={backgroundImage}
            alt=""
            fill
