...
function Logo() {
  return (
    <Link href="/" aria-label="MNA Transport home" className="flex items-center gap-2 text-white">
      ...
      <span className="text-[19px] font-black italic leading-none tracking-[-0.04em]">MNA TRANSPORT</span>
    </Link>
  );
}
...
export default function Footer() {
  return (
    <footer className="bg-[#161616] text-[#d6d6d6]">
      <div className="mx-auto grid w-full max-w-[1107px] gap-10 px-6 pb-10 pt-8 sm:px-10 md:grid-cols-2 lg:grid-cols-[1.55fr_.75fr_1.25fr_1.1fr] lg:gap-16 lg:px-[71px] lg:pb-4 lg:pt-[29px]">
        <div>
          <Logo />
          <p className="mt-3.5 max-w-[218px] text-[9px] leading-[15px] text-[#d1d1d1]">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex min-h-[50px] w-full max-w-[1107px] flex-col items-center justify-between gap-3 px-6 py-4 text-[8px] sm:px-10 md:flex-row lg:px-[71px]">
