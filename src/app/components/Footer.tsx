  ...
  return (
    ...
    >
      <svg
        aria-hidden="true"
        viewBox="0 0 58 42"
        className="h-8 w-11 shrink-0 fill-current"
      >
      ...
      <span className="whitespace-nowrap pr-2 text-[19px] font-black italic leading-none tracking-[-0.04em]">
        MNA TRANSPORT
      </span>
    </Link>
  );
...
export default function Footer() {
  return (
    <footer className="overflow-x-hidden bg-[#161616] text-[#d6d6d6]">
      <div className="mx-auto grid w-full max-w-[1107px] grid-cols-1 gap-9 px-6 pb-10 pt-8 sm:px-10 md:grid-cols-2 lg:grid-cols-[1.55fr_.75fr_1.25fr_1.1fr] lg:gap-16 lg:px-[71px] lg:pb-4 lg:pt-[29px]">
        <div className="min-w-[230px]">
          <Logo />
          <p className="mt-3.5 max-w-[260px] text-[10px] leading-[16px] text-[#d1d1d1] lg:max-w-[218px] lg:text-[9px] lg:leading-[15px]">
        ...
        <div className="min-w-0">
          <h2 className="mb-3 text-[13px] font-bold text-[#df5708]">
            Get In Touch
          </h2>

          <div className="space-y-2.5 text-[11px] leading-[15px] text-[#e0e0e0]">
            <div className="min-w-0">
            ...
            <div className="min-w-0">
              ...
              <address className="max-w-[220px] break-words not-italic lg:max-w-[150px]">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex min-h-[50px] w-full max-w-[1107px] flex-col items-center justify-between gap-4 px-6 py-4 text-center text-[9px] leading-[15px] sm:px-10 md:flex-row md:text-left lg:px-[71px] lg:text-[8px]">
...
function FooterLinks({
  ...
  return (
    <div className="min-w-0">
      ...
      <ul className="space-y-[5px] text-[11px] leading-4">
...
function ContactLabel({
  ...
  const paths = {
    phone: "M5 2 2 4c0 7 5 12 12 12l2-3-4-2-1 2c-3-1-5-3-6-6l2-1-2-4Z",
    email: "M2 4h14v10H2V4Zm1 1 6 5 6-5",
    pin: "M9 17s6-6 6-10A6 6 0 0 0 3 7c0 4 6 10 6 10Zm0-7a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z",
  };

  return (
    <span className="mb-0.5 flex items-center gap-1 text-[9px] text-white">
      <svg
        viewBox="0 0 18 18"
        aria-hidden="true"
