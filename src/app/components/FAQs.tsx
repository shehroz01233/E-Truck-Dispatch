...
export default function FAQSection({
  ...
  return (
    <section className="overflow-hidden bg-[#1c1c1c] px-[1rem] py-[3rem] text-white min-[30rem]:px-[1.5rem] min-[48rem]:px-[2rem] min-[64rem]:px-[3rem] min-[80rem]:py-[5rem]">
      <div className="mx-auto grid w-full max-w-[97.5rem] gap-[2.5rem] overflow-hidden min-[80rem]:grid-cols-[minmax(0,50rem)_minmax(0,44.375rem)] min-[80rem]:items-stretch min-[80rem]:gap-[3.125rem]">
              ...
              <div key={faq.question} className="overflow-hidden">
                ...
                {isActive && (
                  <div className="flex min-h-[4rem] items-start bg-[#161616] px-[1.25rem] pb-[1.25rem] pt-[1rem] min-[30rem]:px-[1.5rem] min-[64rem]:px-[2rem] min-[80rem]:min-h-[5.125rem] min-[80rem]:px-[2.5rem]">
                    <p className="max-w-[44.25rem] font-['DM_Sans'] text-[0.8125rem] leading-[1.55] text-white/90 min-[30rem]:text-[0.875rem] min-[48rem]:text-[0.9375rem] min-[80rem]:text-[1rem] min-[80rem]:leading-[1.5]">
                      {faq.answer}
                    </p>
                  </div>
                )}
        ...
        <div className="order-1 flex min-h-0 w-full min-w-0 flex-col overflow-hidden min-[80rem]:order-2">
          <div className="shrink-0">
            ...
            <p className="mt-[1.5rem] max-w-[38.3125rem] font-['DM_Sans'] text-[0.875rem] leading-[1.55] text-white/85 min-[30rem]:text-[0.9375rem] min-[48rem]:text-[1rem] min-[80rem]:mt-[2.5rem] min-[80rem]:text-[1.125rem] min-[80rem]:leading-[1.5]">
              {description}
            </p>
          </div>

          <div className="relative mt-[2rem] h-[12rem] w-full shrink-0 overflow-hidden min-[30rem]:h-[15rem] min-[48rem]:h-[18rem] min-[64rem]:h-[20.75rem] min-[80rem]:mt-[3.875rem] min-[80rem]:h-auto min-[80rem]:min-h-0 min-[80rem]:flex-1">
            <Image
              src={image}
              alt={imageAlt}
              fill
