...
type HeroSectionProps = {
  ...
  // Ye text hamesha visible rahega
  fixedTitle?: string;

  // Sirf ye text type aur erase hoga
  typingTitles?: string[];
...
export default function HeroSection({
  ...
  const hasTypingTitles =
    Array.isArray(typingTitles) && typingTitles.length > 0;
